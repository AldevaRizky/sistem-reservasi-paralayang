            ...
            <ul class="inline-flex *:min-h-header-height *:inline-flex *:items-center">
                ...
                <li class="dropdown pc-h-item">
                    ...
                    <div class="dropdown-menu pc-h-dropdown drp-search">
                        <form class="px-2 py-1" method="GET" action="{{ url()->current() }}">
            ...
            <ul class="inline-flex *:min-h-header-height *:inline-flex *:items-center">
                <li class="dropdown pc-h-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-end pc-h-dropdown">
                        <a href="#!" class="dropdown-item" onclick="setThemeMode('dark')">
                            <i data-feather="moon"></i>
                            <span>Dark</span>
                        </a>
                        <a href="#!" class="dropdown-item" onclick="setThemeMode('light')">
                            <i data-feather="sun"></i>
                            <span>Light</span>
                        </a>
                        <a href="#!" class="dropdown-item" onclick="setThemeMode('default')">
